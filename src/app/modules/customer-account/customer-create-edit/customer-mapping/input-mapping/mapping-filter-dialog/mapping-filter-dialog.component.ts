...
@Component({
  selector: 'app-mapping-filter-dialog',
  templateUrl: './mapping-filter-dialog.component.html',
  styleUrls: ['./mapping-filter-dialog.component.scss'],
...
export class MappingFilterDialogComponent {
  snackBar: SnackBar;
  ...
  constructor(
    public matDialogRef: MatDialogRef<MappingFilterDialogComponent>, public snack: MatSnackBar,
  ...
  saveRow(i: any) {
    ...
    if (checkObj.search.trim() === '') {
      ...
      this.editDataList = this.dataSource;
    }
  }
