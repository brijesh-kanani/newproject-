...
@Component({
  selector: 'app-receiving-multiple-mapping-dialog',
  templateUrl: './receiving-multiple-mapping-dialog.component.html',
  styleUrls: ['./receiving-multiple-mapping-dialog.component.scss'],
...
export class ReceivingMultipleMappingDialogComponent {
  ...
  constructor(
    public matDialogRef: MatDialogRef<ReceivingMultipleMappingDialogComponent>,
