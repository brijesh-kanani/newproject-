...
@Component({
  ...
  standalone: true,
  imports: [CustomerAccountFilterComponent, CommonModule, MatIconModule, MatTableModule, MatPaginatorModule, MatSortModule, MatMenuModule, MatSnackBarModule, MatTooltipModule, MatCheckboxModule, MatInputModule, FormsModule],
})
export class CustomerAccountComponent {
  ...
  constructor(private snack: MatSnackBar, private dialog: MatDialog, private _router: Router, private _spinner: NgxSpinnerService, private sharedService: SharedService, private customerAccountService: CustomerAccountService, private importService: ImportService, private cdr: ChangeDetectorRef, private fileLogService: FileLogService) {
